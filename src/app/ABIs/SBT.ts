export const SBT_ABI = [
  ...
  },
  {
    ...
    inputs: [
      ...
      { name: '_isSBT', type: 'bool', internalType: 'bool' },
    ],
    outputs: [],
    stateMutability: 'nonpayable',
  },
  ...
  { type: 'error', name: 'BlockNumberTooLarge', inputs: [] },
  ...
  { type: 'error', name: 'InsufficientVotesToMove', inputs: [] },
  ...
  { type: 'error', name: 'VoteCalculationOverflow', inputs: [] },
  { type: 'error', name: 'VoteOverflow', inputs: [] },
