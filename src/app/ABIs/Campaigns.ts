export const CAMPAIGN_ABI = [
  ...
  },
  {
    inputs: [
      ...
      { internalType: 'bytes32[]', name: '_gists', type: 'bytes32[]' },
    ],
    name: 'addCampWinners',
    outputs: [],
  ...
  },
  {
    ...
    name: 'campaigns',
    outputs: [
      { internalType: 'uint256', name: 'sbtId', type: 'uint256' },
      { internalType: 'string', name: 'title', type: 'string' },
      { internalType: 'string', name: 'description', type: 'string' },
      { internalType: 'uint256', name: 'amount', type: 'uint256' },
      { internalType: 'uint256', name: 'startDate', type: 'uint256' },
      { internalType: 'uint256', name: 'endDate', type: 'uint256' },
      { internalType: 'bool', name: 'validateSignatures', type: 'bool' },
  ...
  },
  {
    inputs: [
      { internalType: 'uint256', name: '_campaignId', type: 'uint256' },
      { internalType: 'bytes32', name: '_gist', type: 'bytes32' },
  ...
  },
  {
    ...
    name: 'getStatus',
    outputs: [
      { internalType: 'enum Campaigns.Status', name: '', type: 'uint8' },
    ],
    stateMutability: 'view',
    type: 'function',
  },
