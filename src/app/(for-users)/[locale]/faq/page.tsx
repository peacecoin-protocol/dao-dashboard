      ...
      <div className="flex flex-col w-full items-center justify-center max-xl:mx-10 mx-80 max-xl:my-4 my-20">
        ...
        <Accordion type="single" collapsible className="w-full gap-4">
          <AccordionItem value="item-1">
            <AccordionTrigger>{dict ? dict.faq.q1 : ''}</AccordionTrigger>
            <AccordionContent>
          ...
          <AccordionItem value="item-2">
            <AccordionTrigger>{dict ? dict.faq.q2 : ''}</AccordionTrigger>
            <AccordionContent>
              <video width="1000" height="240" controls preload="auto">
          ...
          <AccordionItem value="item-3">
            <AccordionTrigger>{dict ? dict.faq.q3 : ''}</AccordionTrigger>
            <AccordionContent>
              <video width="1000" height="240" controls preload="auto">
          ...
          <AccordionItem value="item-4">
            <AccordionTrigger>{dict ? dict.faq.q4 : ''}</AccordionTrigger>
            <AccordionContent>
              <video width="1000" height="240" controls preload="auto">
          ...
          <AccordionItem value="item-5">
            <AccordionTrigger>{dict ? dict.faq.q5 : ''}</AccordionTrigger>
            <AccordionContent>
              <video width="1000" height="240" controls preload="auto">
          ...
          <AccordionItem value="item-6">
            <AccordionTrigger>{dict ? dict.faq.q6 : ''}</AccordionTrigger>
            <AccordionContent>
              <video width="1000" height="240" controls preload="auto">
                <source
          ...
          <AccordionItem value="item-7">
            <AccordionTrigger>{dict ? dict.faq.q7 : ''}</AccordionTrigger>
            <AccordionContent>
              <video width="1000" height="240" controls preload="auto">
                <source
