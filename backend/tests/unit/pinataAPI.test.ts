...
describe('pinataAPI', () => {
  ...
  it('getImageGroupId returns SBT group for dev', () => {
    expect(getImageGroupId('dev', 'sbt')).toBe(
      'ec1ac640-dd34-4da3-b7f9-9ca9826dcb50'
    )
  })

  it('getImageGroupId returns NFT group for production', () => {
    expect(getImageGroupId('production', 'nft')).toBe(
      '6b5c304d-6bbb-4366-b5c4-27fe361a92d3'
    )
  })
  ...
  it('buildMetadata creates correct JSON structure', () => {
    expect(
      ...
      attributes: [
        { trait_type: 'votingPower', value: '1000000000000000000000' },
      ],
